...
import spiral.bit.dev.lgbtswipe.views.msgs_views_holders.AppHolderFactory
import spiral.bit.dev.lgbtswipe.views.msgs_views_holders.MessageHolder
...
class SingleChatAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as MessageHolder).drawMsg(mListMessagesCache[position])
    }
